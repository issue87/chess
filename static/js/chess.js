...
function canvasAnimation(){
  ...
  if (selectedSqare != null){
    ...
    ctx.fillRect(89 + selectedSqare[1] * widthOfTile,89 + (7 - selectedSqare[0]) * widthOfTile, widthOfTile, widthOfTile);
  };
    ...
    for (let j in row){
      ...
      if (square != null){
        ...
        ctx.drawImage(chessBoardImage, x_crop, y_crop, widthOfTile, widthOfTile, 
                      89 + square.col_pos * 125, 
                      89 + (7 - square.row_pos) * 125, widthOfTile, widthOfTile);
      };
    };
  };
};
