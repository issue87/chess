...
function canvasAnimation(){
  ...
  if (selectedSqare != null){
    ...
    ctx.fillRect(89.5 + selectedSqare[1] * widthOfTile,89.5 + (7 - selectedSqare[0]) * widthOfTile, widthOfTile, widthOfTile);
  };
    ...
    for (let j in row){
      ...
      if (square != null){
        ...
        ctx.drawImage(chessBoardImage, x_crop, y_crop, widthOfTile, widthOfTile, 
                      89.5 + square.col_pos * 125, 
                      89.5 + (7 - square.row_pos) * 125, widthOfTile, widthOfTile);
      };
    };
  };
};
